			...
			<table class="table table-striped table-bordered table-hover" id="rekam_medis">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="edit.php?id=<?= $data['id_rm'] ?>" class="btn btn-warning btn-xs">
								<i class="glyphicon glyphicon-edit"></i>
							</a>
							<a href="del.php?id=<?= $data['id_rm'] ?>" onclick="return confirm('Yakin manghapus data?')" class="btn btn-danger btn-xs">
